...
class FetchedPet
  ...
  # def pet_finder_search(type_of_animal)
  #   uri = URI("http://api.petfinder.com/pet.find?key=#{ENV["PET_FINDER_API_KEY"]}&animal=#{type_of_animal}&location=02116&format=json")
  #
